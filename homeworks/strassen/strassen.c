               ...
               const size_t n)
{
  ...
  float **aux_matrix = (float **) malloc (sizeof(float *));
  ...
  // Store P3 in aux_matrix
  // P3 = S3 x B11
  improved_strassen_aux(aux_matrix, 0, 0,
               S[2], 0, 0,
               B, B1X, BX1,
               n2);
  ...
  // Compute block C21
  // C21 = P3 + P4
  // Sum P3 that is stored in aux_matrix
  sum_matrix_blocks(C, C2X, CX1,
                    C, C2X, CX1,
                    aux_matrix, 0, 0,
                    n2);
